export const ITEMS = [
  ...
  { id: "oven",     mode: "cps",  name: "Four",           emoji: "🔥", base: 60,         growth: 1.13,  cps: 0.6,    desc: "Produit des cookies lentement." },
  ...
  { id: "cursor",   mode: "mult", name: "Curseur",        emoji: "🖱️", base: 18,        growth: 1.15,  mult: 0.04,  desc: "Augmente la puissance des clics." },
